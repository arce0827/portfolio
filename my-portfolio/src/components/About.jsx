  ...
  return (
    <section id="about" data-fade-in style={{padding: '100px 20px', minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0a0a', opacity: 0, fontFamily: 'var(--font-inter)'}}>
      <div style={{maxWidth: '1000px', width: '100%'}}>
        ...
        <h2 className='section-title font-syncopate' style={{fontSize: '56px', fontWeight: '300', letterSpacing: '3px', color: '#ffffff', margin: '20px 0 100px 0', textTransform: 'uppercase'}}>
          {translations[language].aboutTitle}
        </h2>
        <div className="about-grid" style={{display: 'grid', gridTemplateColumns: '300px 1fr', gap: '60px', alignItems: 'start'}}>
          <div className="about-photo" style={{background: 'rgba(82, 39, 255, 0.2)', border: '1px solid rgba(159, 122, 234, 0.3)', borderRadius: '8px', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <ProfilePic size={300} />
          </div>
          <div>
            <p className=" about-text font-inter" style={{fontSize: '18px', color: '#c9a9e8', lineHeight: '1.8', marginBottom: '20px'}}>
              {translations[language].aboutText1}
            </p>
            <p className="about-text font-inter" style={{fontSize: '18px', color: '#c9a9e8', lineHeight: '1.8', marginBottom: '30px'}}>
